      ...
      <div className="mb-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
          ...
          <div className="bg-white p-2 sm:p-3 rounded-xl shadow-md hover:shadow-xl transition-shadow border-t-4 border-blue-500">
            ...
            <h3 className="text-sm sm:text-base font-bold text-gray-800 mb-1 text-center sm:text-left">Adaptive Learning</h3>
            {/* Hide description on mobile */}
          ...
          {/* Feature 2 - Analytics */}
          <div className="bg-white p-2 sm:p-3 rounded-xl shadow-md hover:shadow-xl transition-shadow border-t-4 border-green-500">
            <div className="mb-1 sm:mb-2 flex justify-center sm:justify-start">
            ...
            <h3 className="text-sm sm:text-base font-bold text-gray-800 mb-1 text-center sm:text-left">Detailed Analytics</h3>
            {/* Hide description on mobile */}
            <p className="hidden sm:block text-gray-600 text-sm leading-relaxed">
          ...
          <div className="bg-white p-2 sm:p-3 rounded-xl shadow-md hover:shadow-xl transition-shadow border-t-4 border-purple-500">
            <div className="mb-1 sm:mb-2 flex justify-center sm:justify-start">
              <svg className="w-8 h-8 sm:w-12 sm:h-12 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
            </div>
            <h3 className="text-sm sm:text-base font-bold text-gray-800 mb-1 text-center sm:text-left">AI Assistant</h3>
            {/* Hide description on mobile */}
            <p className="hidden sm:block text-gray-600 text-sm leading-relaxed">
          ...
          {/* Feature 4 - Import */}
          <div className="bg-white p-2 sm:p-3 rounded-xl shadow-md hover:shadow-xl transition-shadow border-t-4 border-orange-500">
            <div className="mb-1 sm:mb-2 flex justify-center sm:justify-start">
              <svg className="w-8 h-8 sm:w-12 sm:h-12 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
              </svg>
            </div>
            <h3 className="text-sm sm:text-base font-bold text-gray-800 mb-1 text-center sm:text-left">Import Questions</h3>
            {/* Hide description on mobile */}
            <p className="hidden sm:block text-gray-600 text-sm leading-relaxed">
          ...
          {/* Feature 5 - Exam Mode */}
          <div className="bg-white p-2 sm:p-3 rounded-xl shadow-md hover:shadow-xl transition-shadow border-t-4 border-red-500">
            <div className="mb-1 sm:mb-2 flex justify-center sm:justify-start">
              <svg className="w-8 h-8 sm:w-12 sm:h-12 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <h3 className="text-sm sm:text-base font-bold text-gray-800 mb-1 text-center sm:text-left">Exam Mode</h3>
            {/* Hide description on mobile */}
            <p className="hidden sm:block text-gray-600 text-sm leading-relaxed">
          ...
          <div className="bg-white p-2 sm:p-3 rounded-xl shadow-md hover:shadow-xl transition-shadow border-t-4 border-indigo-500">
            <div className="mb-1 sm:mb-2 flex justify-center sm:justify-start">
              <svg className="w-8 h-8 sm:w-12 sm:h-12 text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
            </div>
            <h3 className="text-sm sm:text-base font-bold text-gray-800 mb-1 text-center sm:text-left">Study Tracking</h3>
            {/* Hide description on mobile */}
            <p className="hidden sm:block text-gray-600 text-sm leading-relaxed">
